...
export function handleAdminUI(isAdmin, isMember) { 
    ...
    if (isAdmin) {
        ...
        if (typeof eventsData !== 'undefined' && eventsData.length > 0) renderEvents(eventsData, true, window.currentUserData);
...
export function renderHero(user, userData) {
            ...
            <div class="card bg-white border-2 border-blue-900 p-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Kolla kalendern när nästa tävling är och lägg in om du anmält dig.</p>
                    </div>
            ...
            <div class="card bg-white border-2 border-blue-900 p-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        ...
                        <h2 class="text-2xl font-bold mt-2 text-gray-900">Sugen att börja tävla?</h2>
                        <p class="text-gray-600 mt-1">För att kunna tävla behöver man gå en kurs och skaffa tävlingslicens, läs mer i vår guide.</p>
                    </div>
                    <div class="flex flex-wrap gap-2">
                        <a href="#guider" class="inline-block bg-blue-900 text-white px-6 py-2 rounded-lg font-bold hover:bg-blue-800 transition">Tävlingsguiden</a>
                        <a href="#kalender" class="inline-block bg-gray-100 text-gray-700 px-6 py-2 rounded-lg font-bold hover:bg-gray-200 transition">Kalender</a>
                    </div>
                </div>
            </div>`;
    ...
    container.innerHTML = `
        <div class="card bg-green-800 text-white p-8">
            ...
            <p class="mt-2 text-green-100">Som medlem kan du registrera dina omgångar och se hur du utvecklas här på sidan. Vi har en komplett guide som hjälper dig igång.</p>
